          ...
          const newUsers = [
              {
                  first_name: 'Amelinda',
                  last_name: 'Renjani',
                  email: 'amelinda.renjani_ti22@nusaputra.ac.id',
                  avatar: 'https://i.pravatar.cc/150?img=31',
              },
              {
                  first_name: 'Amel',
                  last_name: 'Linda',
                  email: 'amel_ti22@nusaputra.ac.id',
                  avatar: 'https://i.pravatar.cc/150?img=5',
              },
              {
                  first_name: 'Ren',
                  last_name: 'Jani',
                  email: 'renjani_ti22@nusaputra.ac.id',
  ...
  const updateData = async (id: number) => {
      try {
          const updatedUser = {
              first_name: 'Amel',
              last_name: 'Linda',
              email: 'amelinda_ti22@nusaputra.ac.id',
